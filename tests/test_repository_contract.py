...
TOOLS = (
    ...
    ROOT / "virtualization" / "proxmox-subscription-notice",
    ROOT / "containers" / "compose-service-update",
    ROOT / "monitoring" / "dnf-updates-textfile",
    ...
    ROOT / "networking" / "tcp-reachability-check",
    ROOT / "automation" / "semaphore-project-reconciler",
    ROOT / "security-monitoring" / "unifi-flow-collector",
    ROOT / "identity-and-access" / "windows-online-logon-policy",
    ROOT / "endpoint-management" / "windows-workstation-bootstrap",
    ROOT / "endpoint-management" / "windows-recovery-lockdown",
    ROOT / "endpoint-management" / "windows-session-limits",
    ROOT / "development" / "git-preview-server",
)
...
LOCAL_CONFIGS = (
    ...
    "virtualization/proxmox-subscription-notice/config.local.conf",
    "containers/compose-service-update/config.local.conf",
    "monitoring/dnf-updates-textfile/config.local.conf",
    ...
    "networking/tcp-reachability-check/config.local.json",
    "automation/semaphore-project-reconciler/config.local.toml",
    "security-monitoring/unifi-flow-collector/config.local.toml",
    "identity-and-access/windows-online-logon-policy/config.local.json",
    "endpoint-management/windows-workstation-bootstrap/config.local.json",
    "endpoint-management/windows-recovery-lockdown/config.local.json",
    "endpoint-management/windows-session-limits/config.local.json",
    "development/git-preview-server/config.local.json",
